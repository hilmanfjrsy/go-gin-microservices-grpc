...
const (
	...
	UserService_Verify_FullMethodName   = "/users.UserService/Verify"
)
...
type UserServiceClient interface {
	...
	Verify(ctx context.Context, in *UserVerifyRequest, opts ...grpc.CallOption) (*UserVerifyResponse, error)
}
...
func (c *userServiceClient) Verify(ctx context.Context, in *UserVerifyRequest, opts ...grpc.CallOption) (*UserVerifyResponse, error) {
...
type UserServiceServer interface {
	...
	Verify(context.Context, *UserVerifyRequest) (*UserVerifyResponse, error)
...
func (UnimplementedUserServiceServer) Verify(context.Context, *UserVerifyRequest) (*UserVerifyResponse, error) {
...
func _UserService_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Verify(ctx, req.(*UserVerifyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "auth-service/pb/users.proto",
}
