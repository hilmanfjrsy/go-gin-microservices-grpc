...
const (
	ProductService_GetAll_FullMethodName        = "/products.ProductService/GetAll"
	...
	ProductService_UpdateProduct_FullMethodName = "/products.ProductService/UpdateProduct"
...
type ProductServiceClient interface {
	GetAll(ctx context.Context, in *GetProductsRequest, opts ...grpc.CallOption) (*GetProductsResponse, error)
...
func (c *productServiceClient) GetAll(ctx context.Context, in *GetProductsRequest, opts ...grpc.CallOption) (*GetProductsResponse, error) {
...
type ProductServiceServer interface {
	GetAll(context.Context, *GetProductsRequest) (*GetProductsResponse, error)
...
func (UnimplementedProductServiceServer) GetAll(context.Context, *GetProductsRequest) (*GetProductsResponse, error) {
...
func _ProductService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetAll(ctx, req.(*GetProductsRequest))
	}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "product-service/pb/product.proto",
}
